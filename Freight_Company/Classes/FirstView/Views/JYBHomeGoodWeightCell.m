...
@interface JYBHomeGoodWeightCell ()<UICollectionViewDelegate,UICollectionViewDataSource,UICollectionViewDelegateFlowLayout>
...
@implementation JYBHomeGoodWeightCell
...
- (__kindof UICollectionViewCell *)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath{
    ...
    JYBHomeDockWeightModel *model = [self.dataArr objectAtIndex:indexPath.row];
