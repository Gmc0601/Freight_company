...
- (void)configToolView {
    ...
    self.saveBtn.frame = CGRectMake(self.frame.size.width - 60, 2, 50, 40);
    [self.saveBtn setTitle:@"确认" forState:UIControlStateNormal];
    [self.saveBtn setTitleColor:RGB(75, 157, 252) forState:UIControlStateNormal];
    ...
    self.cancelBtn.frame = CGRectMake(10, 2, 50, 40);
    [self.cancelBtn setTitle:@"取消" forState:UIControlStateNormal];
    [self.cancelBtn setTitleColor:RGB(75, 157, 252) forState:UIControlStateNormal];
...
- (void)setDate:(NSString *)date {
    ...
    [timerArray replaceObjectAtIndex:0 withObject:[NSString stringWithFormat:@"%ld年",[timerArray[0] integerValue]]];
    [timerArray replaceObjectAtIndex:1 withObject:[NSString stringWithFormat:@"%ld月", [timerArray[1] integerValue]]];
    [timerArray replaceObjectAtIndex:2 withObject:[NSString stringWithFormat:@"%ld日", [timerArray[2] integerValue]]];
    [timerArray replaceObjectAtIndex:3 withObject:[NSString stringWithFormat:@"%ld时", [timerArray[3] integerValue]]];
    [timerArray replaceObjectAtIndex:4 withObject:[NSString stringWithFormat:@"%ld分", [timerArray[4] integerValue]]];
